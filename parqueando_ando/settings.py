"""
Django settings for parqueando_ando project.
...
SECRET_KEY = 'django-insecure-%zxp$%3(8bet-r4((6jvugjef&pa+vpx!++&80_iiov*^8ilpy'
...
ROOT_URLCONF = 'parqueando_ando.urls'
...
WSGI_APPLICATION = 'parqueando_ando.wsgi.application'
